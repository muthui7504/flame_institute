  ...
  return (
    <div>
      ...
      <div className="elements">
        ...
        <h4>This program will target spouses to Ministers - Bishops, Apostles, Revs, Pastors and Assistant Pastors. It will be a 6 month class program on the Major Issues that Pastoral Spouses have to deal with in ther day to day ministry. </h4>
        <div className="list">
